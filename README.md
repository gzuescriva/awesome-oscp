...
- [Pentest Mindmap](https://pentestmindmap.com) - Interactive mindmap with 11,600+ pentesting commands covering all OSCP topics: Active Directory, privilege escalation, web hacking, buffer overflow, and network attacks
